...
namespace library
{
    public class Matrix
    {
        ...
        public Matrix Inverse()
        {
            ...
            double[,] inversedM = new double[RowsCount, ColumnsCount];
            ...
            for (int i = 0; i < RowsCount; i++)
                for (int j = 0; j < ColumnsCount; j++)
                {
                    ...
                    inversedM[j, i] = Math.Pow(-1, i + j) * (1.0 / Determinant) * tmp.Determinant;
                }
        ...
        {
            double[,] newMatrix = new double[RowsCount - 1, ColumnsCount - 1];
